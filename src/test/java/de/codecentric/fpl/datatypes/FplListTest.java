...
public class FplListTest {
	...
	@Test
	public void testRestSizeOne() throws EvaluationException {
		FplList list = new FplList(new FplValue[1]);
		FplList rest = list.rest();
		assertEquals(0, rest.size());
	}

	@Test
	public void testRestSizeTwo() throws EvaluationException {
	...
	@Test
	public void testRestSizeHundred() throws EvaluationException {
	...
	@Test
	public void testRestSizeFiftyAppendFifty() throws EvaluationException {
	...
	@Test
	public void testRestSizeTwoFromAppend() throws EvaluationException {
