...
public class StringFunctionsTest extends AbstractFplTest {
	...
	public void describe() throws Exception {
		...
		String[] expected = new String[] { "Function multiply", "Multiply three parameters.",
				"A second line without sense.", "* a comment for a", "* b comment for b with a second line", "* c" };
